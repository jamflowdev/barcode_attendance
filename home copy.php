									...
									<table id="table" style="display:none;" class="table table-bordered table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<center>
														<button type="button" class='btn btn-sm mx-2 px-3 btn-primary log_now' data-uid="<?php echo $row['id']?>" data-barcode="<?php echo $row['barcode']?>" data-id="1">IN AM</button>
														<button type="button" class='btn btn-sm mx-2 px-3 btn-primary log_now' data-uid="<?php echo $row['id']?>" data-barcode="<?php echo $row['barcode']?>" data-id="2">OUT AM</button>
